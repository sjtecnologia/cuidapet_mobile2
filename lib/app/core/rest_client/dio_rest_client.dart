...
import 'package:cuidapet_mobile/app/core/rest_client/interceptors/auth_inteceptor.dart';
...
class DioRestClient implements RestClient {
  ...
  final _options = BaseOptions(
    ...
    connectTimeout:
        int.parse(Environments.param('rest_connection_timeout') ?? '60'),
    receiveTimeout:
        int.parse(Environments.param('rest_receive_timeout') ?? '60'),
  );
